...
public class SoundEventBiome {
    ...
    public static void init() {
        ...
        BIOME_MUSIC_MAP.put(BiomeKeys.FOREST, SoundEventList.MUSIC_OVERWORLD_FOREST);
        BIOME_MUSIC_MAP.put(BiomeKeys.FLOWER_FOREST, SoundEventList.MUSIC_OVERWORLD_FLOWER_FOREST);
        ...
        BIOME_MUSIC_MAP.put(BiomeKeys.JUNGLE, SoundEventList.MUSIC_OVERWORLD_JUNGLE);
        BIOME_MUSIC_MAP.put(BiomeKeys.SPARSE_JUNGLE, SoundEventList.MUSIC_OVERWORLD_SPARSE_JUNGLE);
        BIOME_MUSIC_MAP.put(BiomeKeys.BAMBOO_JUNGLE, SoundEventList.MUSIC_OVERWORLD_BAMBOO_JUNGLE);
        ...
        BIOME_MUSIC_MAP.put(BiomeKeys.DESERT, SoundEventList.MUSIC_OVERWORLD_DESERT);
        ...
        BIOME_MUSIC_MAP.put(BiomeKeys.BADLANDS, SoundEventList.MUSIC_OVERWORLD_BADLANDS);
